 ...
 * Use the [MemberListingFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class MemberListingFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment MemberListingFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            MemberListingFragment().apply {
